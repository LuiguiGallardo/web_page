...
**Database design and curation:** Built and maintained biological databases using PostgreSQL; developed ETL workflows for structured multi-omics data integration; ensured data consistency and quality control.
...
**API development:** Built and consumed RESTful APIs to expose bioinformatics services and integrate external data sources into analysis workflows.
...
Supported large-scale data processing projects by developing automated ETL pipelines with PostgreSQL to ensure efficient integration, cleaning, and transformation of high-volume datasets.
...
Python, R, Bash, SQL, Perl, C#, PostgreSQL, JavaScript

**Bioinformatics Tools & Frameworks:**  
Snakemake, Nextflow, Galaxy, QIIME2, Bioconductor, Biopython, Samtools, BLAST, BWA, Bowtie2

**NGS Data Analysis:**  
Illumina/Nanopore workflows; quality control (FastQC, MultiQC); read alignment; variant calling; de novo assembly; genome/transcriptome annotation
...
Statistical modeling, machine learning, visualization with ggplot2, seaborn, matplotlib, and R Shiny

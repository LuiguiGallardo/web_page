...
aboutme: "Data Scientist passionate about Computer Science and Software Development looking for new challenges to apply and expand my skills"
...
tribble(
  ...
  "", "Data Scientist", "January 2019 - December 2022", "Institute of Biotechnology, UNAM",  
) %>% 
...
tribble(
  ~ empty, ~ Degree, ~ Year, ~ Institution,
  "", "Software Engineer", "May 2016 - July 2016", "Dept. of Computer Science, CUCEI",  
) %>% 
  detailed_entries(empty, Year, Degree, Institution)
```
...
tribble(
  ~ empty, ~ Degree, ~ Year, ~ Institution,
  "", "Data Scientist (Internship)", "January 2016 - July 2016", "Institute of Biotechnology, UNAM",  
) %>% 
  detailed_entries(empty, Year, Degree, Institution)
```

...
aboutme: "Data Engineer, passionate about Big Data, Computer Science, and Machine Learning, looking for new challenges to apply and expand my skills"
...
```
Master of Science (Computer Science and Biochemistry)
...
tribble(
  ...
  detailed_entries(Degree, Year, Institution, Where)
```
Bachelor of Science (Computer Science and Molecular Biology)

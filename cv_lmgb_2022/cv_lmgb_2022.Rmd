...
tribble(
  ...
  "Data Engineer | Bioinformatician", "January 2019 - December, 2022", "Institute of Biotechnology, UNAM",
) %>% 
...
tribble(
  ~ Degree, ~ Year, ~ Institution,
  "Data Engineer | Bioinformatician (Internship)", "January, 2016 - July, 2016", "Institute of Biotechnology, UNAM",
) %>% 
  detailed_entries(Degree, Year, Institution)
```

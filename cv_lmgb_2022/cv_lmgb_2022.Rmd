...
position: "Data Engineer & Bioinformatician"
...
aboutme: "Data Engineer and Scientist passionate about Big Data, Bioinformatics, and Machine Learning, looking for new challenges to apply and expand my skills."
...
# About me
 * In recent years, I participated in different projects using modern Genomic technologies (NGS), Data Engineering, and Data Science, to obtain novel information that culminated in high-impact peer-reviewed scientific publications".

# Experience
```{r}
tribble(
  ~ Degree, ~ Year, ~ Institution,
  "Data Engineer", "January 2019 - December, 2022", "Institute of Biotechnology, UNAM",
) %>% 
...
* Server management (HPC): managed the Laboratory's server, installed of Linux operative systems and specific software/packages, avoided server slowdowns, and built secure server environments
...
* Presentations to the general public and academic events: participate in scientific dissemination, specialized seminars, and congresses

```{r}
tribble(
  ~ Degree, ~ Year, ~ Institution,
  "Data Analyst (Part-time)", "October, 2016 - December, 2017", "Appen",
) %>% 
  detailed_entries(Degree, Year, Institution)
```
...
tribble(
  ~ Degree, ~ Year, ~ Institution,
  "Data Engineer (Internship)", "January, 2016 - July, 2016", "Institute of Biotechnology, UNAM",
) %>% 
  detailed_entries(Degree, Year, Institution)
```
...
tribble(
  ~ Degree, ~ Year, ~ Institution,
  "Mathematics Teacher", "January, 2014 - December, 2015", "Student Coaching",
) %>% 
  detailed_entries(Degree, Year, Institution)
```
...
* Applied weekly assessments for each student

# Education
```{r}
tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Where,
  "Ph.D.", "January, 2019 - December, 2022", "National Autonomous University of Mexico", "Cuernavaca, Mexico",
  "Master of Science", "August, 2016 - January, 2019", "National Autonomous University of Mexico", "Mexico City, Mexico",
  "Bachelor of Biology", "August, 2012 - January, 2016", "University of Guadalajara", "Guadalajara, Mexico"
) %>% 
